(function () {
    ...
    angular
        ...
        .controller('transactionlogController', TransactionlogController);
    /*jshint maxparams:13*/
    TransactionlogController.$inject = ['$state', 'logger', '$http', '$epGenericDataService',
        '$stateParams', 'localStorageService', 'epOfferFcty', '$rootScope', 
         'epAxisSettingsVal'
    ];
    function TransactionlogController($state, logger, $http,
