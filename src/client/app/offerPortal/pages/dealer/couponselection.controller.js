(function () {
    ...
    angular
        ...
        .controller('couponselectionController', CouponselectionController);
    /*jshint maxparams:13*/
    CouponselectionController.$inject = ['$state', 'logger', '$http', '$epGenericDataService',
        '$stateParams', 'localStorageService', 'epOfferFcty', '$rootScope', 
         'epAxisSettingsVal'
    ];
    function CouponselectionController($state, logger, $http,
